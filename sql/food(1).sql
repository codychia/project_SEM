...
(1, 'Italian Pizza', 25, 0),
(2, 'Greek Pizza', 20, 0),
(3, 'Caucasian Pizza', 20, 0),
(4, 'American Pizza', 15, 0),
(5, 'Tomatoe Pie Pizza', 20, 0),
(6, 'Margherita Pizza', 15, 1);
...
(6, 'Customer', 'anees', 'anees', '123abc', NULL, NULL, 123456789, 0, 0);
