...
<div>
              ...
              <div class="errorTxt5"></div>
                        ...
                        <div class="input-field col s12">
                          <i class="mdi-action-account-circle prefix"></i>
                          <input name="phone" id="phone" type="number" value="<?php echo $cc_number;?>" data-error=".errorTxt5">
              ...
              <div class="errorTxt5"></div>
                        ...
                        <div class="input-field col s12">
                          <i class="mdi-action-account-circle prefix"></i>
                          <input name="phone" id="phone" type="number" value="<?php echo $cvv;?>" data-error=".errorTxt5">
